...
export default function FiltersButton({ className, ...props }) {
  const classes = classNames({
    "FiltersButton--container": true,
    [className]: className
  });
  ...
  return (
    <div className={classes} {...props}>
      ...
      <h5 className="fnt-button1 fgc-darkOrange">FILTERS</h5>
    </div>
  );
}
